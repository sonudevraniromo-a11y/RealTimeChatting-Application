...
const { changePassword , deleteUser , changeRole , getAllUsers ,searchUsers } = require('../controllers/userControllers');
...
route.put('/change-password',authMiddleware  , changePasswordValidator , validateRequest , changePassword)
